        ...
        <div className="bg-gray-100 min-h-screen p-8">
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row md:justify-center">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs w-full text-center">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">Jose <br />Garcia Escobar</h3>
            ...
            <div className="mt-12 max-w-3xl mx-auto p-6 bg-blue-100 rounded-lg shadow-lg text-center">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                    En el crecimiento de la tecnología es necesario simplificar tareas y optimizar cálculos manuales para acelerar el tiempo de producción en distintas áreas. Con la guía del Ing. Richard Josephia y el esfuerzo del equipo de desarrollo, logramos llevar este proyecto a la realidad.
                </p>
            </div>
        </div>
    );
