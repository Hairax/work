            ...
            <div className='flex flex-row justify-center w-full'>
              ...
              <div class="w-2/6 max-w-sm bg-gray-100 rounded-lg shadow-lg dark:border-gray-700 pt-6">
                <div className='flex flex-row items-center justify-center'>
                  <div class="flex flex-col items-center pb-10 pt-10x">
                      <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src={Logo} alt="logo imagen"/>
                      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-black">Jose Garcia</h5>
                      <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span>
                      <div class="flex mt-4 md:mt-6">
                          <a href="https://www.facebook.com/josedaniel.garcia.587" class="inline-flex items-center ">
                            <MdOutlineFacebook className="w-8 h-8" />
                          </a>
                          {/* <a href="#" class="inline-flex items-center ">
                            <AiFillLinkedin className="w-8 h-8" />
                          </a> */}
                          <a href="https://www.instagram.com/jdg69219/" class="inline-flex items-center ">
                            <AiFillInstagram className="w-8 h-8" />
                          </a>
                      </div>
                  </div>
